...
if ( function_exists( 'wfLoadExtension' ) ) {
	...
	wfWarn(
		'Deprecated PHP entry point used for WSua extension. Please use wfLoadExtension ' . 'instead, see https://www.mediawiki.org/wiki/Extension_registration for more details.'
	);
